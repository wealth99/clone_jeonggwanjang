...
const sec02Animation = () => {
    gsap.to('.sec-02 .sec-inner', {alpha: 1, y: 0, duration: .8, scale: 1, delay: 0.5, onComplete: () => {
        locoScroll.start();
    }});
    ...
    .to('.sec-02 .bg-cover', {alpha: 1, scaleX: 1, ease: Linear.easeNone, duration: 1}, '+=.2')
...
const sec03Animation = () => {
    ...
    .to('.sec-03 .cont-group', {autoAlpha: 0, duration: 1}, 1.5)
...
const sec04Aniamtion = () => {
   gsap.timeline({
    ...
    .to('.sec-04 .cont-01 .cont-col:nth-of-type(1)', {y: 0, alpha: 1, duration: 1, ease: Linear.easeNone}, 0)
    ...
    .to('.sec-04 .cont-02 .cont-col:nth-of-type(2)', {y: 0, alpha: 1, duration: 1, ease: Linear.easeNone}, 0)
...
const sec05Animation = () => {
    ...
    .to('.sec-05 .tit', {y: 0, alpha: 1, duration: 1, ease: Quint.easeOut}, 0)
    ...
    .to('.sec-05 .cont-img', {y: 0, duration: 1, ease: Linear.easeNone}, 0)
...
const sec06Animation = () => {
    ...
    .to('.sec-06 .tit', {autoAlpha: 1, y: 0, duration: 1, ease: Quint.easeOut}, 0)
...
const sec07Animation = () => {
    ...
    .to('.sec-07 .cont-01 .product-group .img', {y: 0, height: '40%', duration: 1, ease: Linear.easeNone}, 0)
    ...
    .to('.sec-07 .cont-01 .cont-over', {clipPath: 'inset(0px 0px 0px)', duration: 1, ease: Linear.easeNone}, 0)
    ...
    .to('.sec-07 .cont', {overflow: 'hidden'}, 0)
...
const sec08Animation = () => {
    ...
    .to('.sec-08 .bg-cover', {alpha: 0.2,  duration: 1, ease: Linear.easeNone}, 0)
